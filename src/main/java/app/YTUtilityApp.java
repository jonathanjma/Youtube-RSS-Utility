...
public class YTUtilityApp extends Application {
    ...
    public void homeScreen() {
        ...
        Button update = new Button("", new ImageView(
                new Image("refresh.png", 15, 15, false, false)));
    ...
    public void loadingScreen(String channelId) {
        ...
        ImageView view = new ImageView(new Image("loading.gif"));
    ...
    public HBox createHeader(Channel channel) {
        ...
        ImageView homeImg = new ImageView(new Image("home.png", 30, 30,
                true, true));
    ...
    public Group createChannelElementsGroup(Channel channel) {
        ...
        Button homeBtn = new Button("", new ImageView(
                new Image("home.png", 20, 20, true, true)));
    ...
    public void loadFonts() {
        ...
        Font.loadFont(getClass().getResource("/OpenSans/OpenSans-Bold.ttf").toExternalForm(), 14);
        Font.loadFont(getClass().getResource("/OpenSans/OpenSans-BoldItalic.ttf").toExternalForm(), 14);
        Font.loadFont(getClass().getResource("/OpenSans/OpenSans-ExtraBold.ttf").toExternalForm(), 14);
        Font.loadFont(getClass().getResource("/OpenSans/OpenSans-ExtraBoldItalic.ttf").toExternalForm(), 14);
        Font.loadFont(getClass().getResource("/OpenSans/OpenSans-Italic.ttf").toExternalForm(), 14);
        Font.loadFont(getClass().getResource("/OpenSans/OpenSans-Light.ttf").toExternalForm(), 14);
        Font.loadFont(getClass().getResource("/OpenSans/OpenSans-LightItalic.ttf").toExternalForm(), 14);
        Font.loadFont(getClass().getResource("/OpenSans/OpenSans-Regular.ttf").toExternalForm(), 14);
        Font.loadFont(getClass().getResource("/OpenSans/OpenSans-SemiBold.ttf").toExternalForm(), 14);
        Font.loadFont(getClass().getResource("/OpenSans/OpenSans-SemiBoldItalic.ttf").toExternalForm(), 14);
    }
